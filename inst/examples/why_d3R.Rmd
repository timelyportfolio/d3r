...
listviewer::jsonedit(
  jsonlite::toJSON(
    d3n, auto_unbox=TRUE, dataframe="rows"
  )
)
```
...
Titanic %>>%
  ...
  # also think I'll provide helper for this
  #  see https://github.com/timelyportfolio/d3r/issues/1
  jsonlite::toJSON(auto_unbox=TRUE, dataframe="rows") %>>%
  listviewer::jsonedit()
```
